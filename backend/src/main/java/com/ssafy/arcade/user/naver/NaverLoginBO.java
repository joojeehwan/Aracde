package com.ssafy.arcade.user.naver;
...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "Jb6yH7fmEzBhClzMoClq";       //네이버API Client ID
    private final static String CLIENT_SECRET = "086J2INDmq";
    private final static String REDIRECT_URI = "http://localhost:3000/login/oauth2/naver";
